...
| R7 | `healthResponse` now requires `ports`. Any health fixture or mock handler without it fails response parsing. | The contract changed after both consuming lanes were written. | W1-H (the mock handler and the Environment card; W2-C inherits the corrected fixture) |
