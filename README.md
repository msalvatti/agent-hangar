...
| **Worker memory**        | plaintext exists only inside the call that starts one turn; it is never stored on an object and never logged                                                                                                                                                                                                                                                                                                                                            |
